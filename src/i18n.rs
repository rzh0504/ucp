...
static ZH: Translations = Translations {
    ...
    hide_after_copy_hint: "从历史中复制记录成功后，将主窗口隐藏到托盘。",
    about: "关于",
...
static EN: Translations = Translations {
    ...
    hide_after_copy_hint: "After a history item is copied, hide the main window to the tray while clipboard monitoring keeps running.",
    about: "About",
