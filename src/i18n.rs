...
pub struct Translations {
    ...
    pub app_version_hint: &'static str,
...
static ZH: Translations = Translations {
    ...
    about: "关于",
    app_version: "版本号",
    app_version_hint: "当前安装的 UCP Clipboard 应用版本。",
    open_source_repository: "开源仓库",
    open_source_repository_hint: "查看源代码、问题反馈和发布信息。",
    display: "外观",
...
static EN: Translations = Translations {
    ...
    about: "About",
    app_version: "Version",
    app_version_hint: "The installed UCP Clipboard app version.",
    open_source_repository: "Open-source repository",
    open_source_repository_hint: "View source code, issue tracking, and release information.",
    display: "Appearance",
